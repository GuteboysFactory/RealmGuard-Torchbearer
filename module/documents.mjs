...
export class RealmGuardActor extends Actor {
  ...
  _rollAssist({ traitId = null, wiseId = null, traitMode = "help", versus = false } = {}) {
    ...
    return { trait, traitStatus, wise, requestedWise, traitMode: mode, requestedTraitMode: requestedMode, traitPoolDice, traitDice: traitPoolDice + wiseDice, wiseDice, opponentDice, checks, blockedTraitHelp, blockedTraitReason, blockedWise, strict };
  }
