...
export function strictConversionPreviewHtml(preview) {
  ...
  return `<div class="realm-guard rg-rules-registry-scroll" style="padding:4px 10px;max-height:calc(100vh - 190px);overflow:auto;">
    ...
    <div style="margin:12px 0;padding:9px;border-left:3px solid currentColor;background:rgba(128,128,128,.08);"><b>No Activate / Convert action exists in qa.2.</b><br><small>Writes planned: 0 · destructive conversion: NO.</small></div>
